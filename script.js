...
if (form) {
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (!userId) {
                throw new Error('Не удалось определить ID пользователя. Пожалуйста, откройте Mini App через бота.');
            }
            ...
            console.log('📤 URL для отправки:', window.location.origin + '/api/appointment');
